...
| Current IMPSY hub        | `_projects/2_project.md`                             | Implemented          | 2026-06-25   | Expanded with HCI + systems framing, implemented screen areas, user perspectives, contribution framing, and project nav. |
| Process page             | `_pages/impsy-interface-process.md`                  | Implemented          | 2026-06-25   | Expanded with Double Diamond framing, old-interface baseline, user-story role, interface specs, and project nav.         |
| System page              | `_pages/impsy-interface-system.md`                   | Implemented          | 2026-06-25   | Expanded with architecture, interaction modes, log-to-model flow, model traceability, distinct workflow images, and nav. |
| Study page               | `_pages/impsy-interface-study.md`                    | Implemented          | 2026-06-25   | Expanded with method, SUS interpretation, themes, limits, future work, study-specific images, and project nav.           |
| Gallery page             | `_pages/impsy-interface-gallery.md`                  | Implemented          | 2026-06-25   | Main design archive with top/bottom project nav.                                                                         |
| Resources page           | `_pages/impsy-interface-resources.md`                | Implemented          | 2026-06-25   | Expanded with thesis-vs-NIME framing, public-safety boundary, asset allocation, and project nav.                         |
...
| Navigation/content pass  | `output/impsy-navigation-content-pass.md`            | Checked              | 2026-06-25   | Added shared subpage navigation and expanded pages with public-safe thesis content.                                      |
