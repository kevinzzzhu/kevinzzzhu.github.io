...
| Gallery page             | `_pages/impsy-interface-gallery.md`                  | Implemented          | 2026-06-25   | Rebuilt into process, system, and context groups with selected thesis-first visuals.                  |
...
| Asset Curator            | `output/impsy-thesis-asset-curation.md`              | Checked              | 2026-06-25   | Agent 3 selected visual candidates; Agent 4 copied the approved subset into `assets/img/`.            |
