...
| Current IMPSY hub        | `_projects/2_project.md`                             | Implemented          | 2026-06-26   | Expanded with HCI + systems framing, implemented screen areas, user perspectives, and contribution framing. Overview keeps project-level side arrows. |
| Process page             | `_pages/impsy-interface-process.md`                  | Implemented          | 2026-06-26   | Expanded with Double Diamond framing, old-interface baseline, user-story role, and interface specs. Side arrows link overview/system.                 |
| System page              | `_pages/impsy-interface-system.md`                   | Implemented          | 2026-06-26   | Expanded with architecture, interaction modes, log-to-model flow, model traceability, and distinct workflow images.                                   |
| Study page               | `_pages/impsy-interface-study.md`                    | Implemented          | 2026-06-26   | Expanded with method, SUS interpretation, themes, limits, future work, and study-specific images.                                                     |
| Gallery page             | `_pages/impsy-interface-gallery.md`                  | Implemented          | 2026-06-26   | Main design archive; side arrows link study/resources.                                                                                                |
| Resources page           | `_pages/impsy-interface-resources.md`                | Implemented          | 2026-06-26   | Expanded with thesis-vs-NIME framing, public-safety boundary, and asset allocation. Side arrows link gallery/overview.                                |
...
| Navigation/content pass  | `output/impsy-navigation-content-pass.md`            | Checked              | 2026-06-26   | Replaced in-page button nav with layout-level side-arrow routing for IMPSY subpages. Expanded pages remain public-safe.                               |
...
| `.../IMPSY_Web_Interface_NIME_2026/images/new-impsy-improvisation.jpg` | `assets/img/impsy-improvisation-visualisation.jpg` | Existing | Hub                    | Kept as the hub's live-performance overview image.                    |
| `.../IMPSY_Web_Interface_NIME_2026/images/configuration.jpg`           | `assets/img/impsy-configuration.jpg`               | Existing | Gallery / archive      | Removed from study/system pages to avoid repeated subpage imagery.    |
| `.../IMPSY_Web_Interface_NIME_2026/images/dataflow.png`                | `assets/img/impsy-dataflow.png`                    | Existing | Gallery / archive      | Kept in gallery after duplicate system-design image was removed.      |
...
| `.../figures/system-design.jpg`                                        | `assets/img/impsy-system-design.jpg`               | Skipped  | Gallery / system       | Removed on 2026-06-25 because it duplicated the dataflow diagram.     |
...
| `.../figures/new-impsy/new-impsy-home.jpg`                             | `assets/img/impsy-new-home.jpg`                    | Copied   | System walkthrough     | Used as the connect/start image.                                      |
| `.../figures/new-impsy/new-impsy-improvisation.jpg`                    | `assets/img/impsy-new-improvisation.jpg`           | Copied   | System walkthrough     | Used instead of repeating the hub's NIME improvisation image.         |
| `.../figures/new-impsy/new-impsy-logvis-combined.jpg`                  | `assets/img/impsy-new-logvis-combined.jpg`         | Copied   | System walkthrough     | Used for inspect-recorded-data section.                               |
| `.../figures/new-impsy/new-impsy-training.jpg`                         | `assets/img/impsy-new-training.jpg`                | Copied   | System walkthrough     | Used for train/choose-model section.                                  |
| `.../figures/new-impsy/new-impsy-model-detail.jpg`                     | `assets/img/impsy-new-model-detail.jpg`            | Copied   | System walkthrough     | Used for model-detail/return-to-performance section.                  |
| `.../figures/study-preparation/configuration.jpg`                      | `assets/img/impsy-study-session-setup.jpg`         | Copied   | Study page             | Public-safe setup image with browser, controller, and audio context.  |
| `.../figures/data-collection/quantitative/sus_avg_scores_bar.png`      | `assets/img/impsy-study-sus-average.png`           | Copied   | Study page             | Used as public-safe SUS summary signal.                               |
