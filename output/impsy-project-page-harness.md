...
| Sensitive file scan           | `find assets ... rg ...`                                | Checked              | 2026-06-23   | No matches for copied IMPSY assets; only pre-existing unrelated matches under publication previews and PickNPlay. |
