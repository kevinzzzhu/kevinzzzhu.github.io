...
| System page              | `_pages/impsy-interface-system.md`                   | Implemented          | 2026-06-25   | Uses distinct redesigned workflow screens for connect/play, response, logs, training, and model detail.                  |
| Study page               | `_pages/impsy-interface-study.md`                    | Implemented          | 2026-06-25   | Uses study-specific setup and SUS chart images; no longer repeats configuration/system screenshots.                      |
...
| Resources page           | `_pages/impsy-interface-resources.md`                | Implemented          | 2026-06-25   | Updated website-assets list to record page-specific image allocation.                                                    |
